...
// and reduce the possibility of having them thrown at runtime.
    var name: String = "Selvi"
// name = null // Compilation Error

    var nullableName: String? = "Selvi"
...
// but the same methods won't work on nullable types,cunku burda soru isaretlerini kullanmali
    /*
  ...
  */
    ...
    //null olan bir degeri cagirinca hata aliriz bu durumu onlemek icin de elvis oparator kullanilir.
    // eger variable null olarak atanmis ise bunu Elvis Oparator kullanarak problemi cozebiliriz.
    //ve burda ?: kullanilir.

    nullableName = null
    val name1 = nullableName ?: "Halil"
...
// So how can we solve this? We could do a null check beforehand
    ...
    if(nullableName2 != null) {
        println("Hello, ${nullableName2.toLowerCase()}.") //Hello, mesut.
        println("Your name is ${nullableName2.length} characters long.") //Your name is 5 characters long.
    } else {
        println("Hello, Guest")
    }
...
// the variable.
    ...
    var nullable6 = "HALIL"
   println( nullable6!!.toLowerCase()) //halil
